...
定义图层的画板控件
 ...
 - linux_23: 2007.5.29; 添加绘制Label的代码
 - linux_23: 2007.9.7; 添加HLLayerCanvas类
 - linux_23: 2007.9.15; 添加FeaturesCanvas类
 - linux_23: 2007.11.28; 添加透明显示效果
"""
...
from geosings.core.LabelLayout import LabelLayout
...
class LayerCanvas:
    ...
    def Create(layer):
        ...
        if layer.type == DataSetType.Vector:
            return VectorCanvas(layer)
        elif layer.type == DataSetType.Raster:
            return RasterCanvas(layer)
        else:
            return None
...
class VectorCanvas(LayerCanvas):
    ...
    def Draw(self,dc,wprect,wgrect):
        ...
        debug('spend time:',end-star,self.ctime)
    ...
    def __GetPoints(self,georef,scale,x,y,mx,my):
...
class FeaturesCanvas(VectorCanvas):
    """要素的画板
    """
    def __init__(self,features):
        ...
        layer = mainDocument.map.GetLayers()[0]
        VectorCanvas.__init__(self,layer)
...
class RasterCanvas(LayerCanvas):
    """栅格图层的画板
    """
    def __init__(self,layer):
        """初始化画板
